...
public class Consola extends Armadura implements Composicion {
    ...
    public Consola(int consumo, boolean danio, boolean destruido) {
    ...
    public void reparandoDanios() {
        ...
        do {
            ...
            if (this.isDanio()==true) {
                ...
                System.out.println("se reparo con exito la consola");
            }
